...
export const { reducer: QuanLyKhoaHocAdminReducer, actions: QuanLyKhoaHocAdminActions } = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(quanLyKhoaHocThunkAction.quanLyGhiDanhNguoiDung.pending, (state, action) => {
               
                state.loading.quanLyGhiDanhNguoiDung = true;
            })
            .addCase(quanLyKhoaHocThunkAction.quanLyGhiDanhNguoiDung.fulfilled, (state, action) => {
                console.log('quanLyGhiDanhNguoiDung pending');
                state.loading.quanLyGhiDanhNguoiDung = false;
            })
            .addCase(quanLyKhoaHocThunkAction.quanLyGhiDanhNguoiDung.rejected, (state, action) => {
                state.loading.quanLyGhiDanhNguoiDung = false;
            })
